            ...
            if (!running)
            {
                ...
                using (SettingsForm sf = new SettingsForm(Global.DefaultGameSettings))
                {
                    ...
                    if (GameConfig != null && !string.IsNullOrEmpty(GameConfig.SiteConfig))
                    {
                        ...
                        // Always pick up the latest base bet the user saved in Settings,
                        // overriding whatever was stored in the panel's old GameConfig.
                        sf.GameConfig.BetCost = Properties.Settings.Default.BetCost;
                    }
